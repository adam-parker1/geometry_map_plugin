...
int GeometryMapReader(IDAM_PLUGIN_INTERFACE* plugin_interface) {
    //----------------------------------------------------------------------------------------
    ...
    try {
        static GeometryMapReaderPlugin plugin = {};
 ...
 * @return
 */
int GeometryMapReaderPlugin::help(IDAM_PLUGIN_INTERFACE* interface) {
 ...
 * @return
 */
int GeometryMapReaderPlugin::version(IDAM_PLUGIN_INTERFACE* interface) {
 ...
 * @return
 */
int GeometryMapReaderPlugin::build_date(IDAM_PLUGIN_INTERFACE* interface) {
 ...
 * @return
 */
int GeometryMapReaderPlugin::default_method(IDAM_PLUGIN_INTERFACE* interface) {
 ...
 * @return
 */
int GeometryMapReaderPlugin::max_interface_version(IDAM_PLUGIN_INTERFACE* interface) {
